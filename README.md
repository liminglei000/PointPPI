...
Here is the code for paper PCLT-PPI: Predicting Multi-type Interactions between Proteins based on Point Cloud Structure and Local Topology Preservation.
